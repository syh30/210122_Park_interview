...
3. [Dev MVP : 모바일팀] 안드로이드 앱 개발자 박진우님을 만나다.
4. [Dev MVP : 모바일팀 박진우님] “기술적인 성장을 얻어갈 수 있는 기회”
5. [모바일팀 인터뷰] 도전하는 개발자 박진우님
6. [모바일팀 인터뷰] 안드로이드 앱 개발자 박진우님
7. [개발자 인터뷰] 도전하는 개발자, 모바일팀 박진우님
8. [인터뷰] 모바일팀 안드로이드 앱 개발자 박진우님
